...
USB\ Device\ -\ CDC\ -\ Basic\ Demo\ -\ \ C18\ -\ PICDEM\ FSUSB.cof : Objects/PICDEM\ FSUSB/usb_descriptors.o Objects/PICDEM\ FSUSB/main.o Objects/PICDEM\ FSUSB/arsh.o Objects/PICDEM\ FSUSB/usb_function_cdc.o Objects/PICDEM\ FSUSB/usb_device.o
...
Objects/PICDEM\ FSUSB/arsh.o : shell/arsh.c /opt/microchip/mplabc18/v3.40/h/ctype.h /opt/microchip/mplabc18/v3.40/h/stdlib.h /opt/microchip/mplabc18/v3.40/h/string.h ../../Microchip/Include/USB/usb_common.h ../../Microchip/Include/USB/usb_device.h ../../Microchip/Include/USB/usb_hal.h ../../Microchip/Include/USB/usb_function_cdc.h main.c ../../Microchip/Include/USB/usb.h ../../Microchip/Include/GenericTypeDefs.h /opt/microchip/mplabc18/v3.40/h/stddef.h ../../Microchip/Include/Compiler.h /opt/microchip/mplabc18/v3.40/h/p18cxxx.h /opt/microchip/mplabc18/v3.40/h/p18f4550.h /opt/microchip/mplabc18/v3.40/h/stdarg.h usb_config.h /opt/microchip/mplabc18/v3.40/h/limits.h ../../Microchip/Include/USB/usb_ch9.h ../../Microchip/Include/USB/usb_hal_pic18.h HardwareProfile.h HardwareProfile\ -\ PICDEM\ FSUSB.h
	mkdir -p "Objects/PICDEM FSUSB"
	$(CC) -p=18F4550 -I"/opt/microchip/mplabc18/v3.40/h" -I"../../Microchip/Include" -I"." "shell/arsh.c" -fo="./Objects/PICDEM FSUSB/arsh.o" $(CCOPT)

clean : 
	$(RM) "Objects/PICDEM FSUSB/usb_descriptors.o" "Objects/PICDEM FSUSB/main.o" "Objects/PICDEM FSUSB/usb_function_cdc.o" "Objects/PICDEM FSUSB/usb_device.o" "Objects/PICDEM FSUSB/arsh.o" "USB Device - CDC - Basic Demo -  C18 - PICDEM FSUSB.cof" "USB Device - CDC - Basic Demo -  C18 - PICDEM FSUSB.hex" "USB Device - CDC - Basic Demo -  C18 - PICDEM FSUSB.map"
